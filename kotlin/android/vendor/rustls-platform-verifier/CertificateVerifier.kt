// Vendored from rustls-platform-verifier v/0.7.0. See README.md in this directory.
...
// Match the upstream production build. Never enable test trust overrides or bypasses.
    ...
    private fun verifyCertificateChain(
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            ...
            revocationChecker.options = EnumSet.of(
                ...
                // Modern public CAs may publish only CRLs. Android reports a missing
                // OCSP responder as a hard failure even when SOFT_FAIL is set.
                // Retain OCSP verification when the server supplies a staple.
